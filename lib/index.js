...
module.exports = conversion.convertToZStream;
module.exports.isClassicStream = conversion.isClassicStream;
module.exports.isRequestStream = conversion.isRequestStream;
...
module.exports.request = function(url, options) {
	...
	return new module.exports(request(options), requestStreamOptions);
};
